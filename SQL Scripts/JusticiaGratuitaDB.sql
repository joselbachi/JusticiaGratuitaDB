...
(
   ID   				DOUBLE     DEFAULT (NEXT VALUE FOR PUBLIC.SEQ_Comision_id) NOT NULL,
...
CREATE SEQUENCE SEQ_Expediente_id START WITH 1 INCREMENT BY 1 NOCYCLE CACHE 1;
CREATE SEQUENCE SEQ_Expediente_Turno START WITH 1 INCREMENT BY 1 NOCYCLE CACHE 1;

CREATE TABLE EXPEDIENTE
(
   ID                   DOUBLE         DEFAULT (NEXT VALUE FOR PUBLIC.SEQ_Expediente_id) NOT NULL,
   IDSOLICITANTE        DOUBLE    		 NOT NULL,
   IDJUZGADO						DOUBLE				 NOT NULL,
   IDLETRADO						DOUBLE,
   IDPROCURADOR					DOUBLE,
   NUMTURNO							DOUBLE				 DEFAULT (NEXT VALUE FOR PUBLIC.SEQ_Expediente_Turno) NOT NULL,
   ANYO									INT						 NOT NULL,
   IDCOMISION						DOUBLE,
   FECENTRADACOL				DATE 					 DEFAULT SYSDATE NOT NULL,
   FECENVIODEL					DATE,
   FECENTRADADEL				DATE,
   FECRESOLUCION				DATE,
   FECIMPUGNACION				DATE,
